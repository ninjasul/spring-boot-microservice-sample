...
COPY ./build/libs/spring-boot-microservice-sample-0.0.1-SNAPSHOT.jar /usr/app/microservice-sample.jar
...
ENTRYPOINT ["java","-Djava.security.egd=file:/dev/./urandom","-jar","microservice-sample.jar"]
